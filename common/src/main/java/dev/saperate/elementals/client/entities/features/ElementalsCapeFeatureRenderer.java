        ...
        if (!entity.isInvisible() && entity.getOwner().isModelPartShown(PlayerModelPart.CAPE)) {
            ...
            if (skinTextures.capeTexture() != null) {
                ...
                if (!itemStack.is(Items.ELYTRA)) {
                    ...
                    double d = Mth.lerp(h, entity.prevCapeX, entity.capeX) - Mth.lerp(h, entity.xo, entity.getX());
                    double e = Mth.lerp(h, entity.prevCapeY, entity.capeY) - Mth.lerp(h, entity.yo, entity.getY());
                    double m = Mth.lerp(h, entity.prevCapeZ, entity.capeZ) - Mth.lerp(h, entity.zo, entity.getZ());
